    ...
    <div className="space-y-6">
      ...
      {selectedEmployee && (
        <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center sm:p-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-t-3xl md:rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom md:slide-in-from-bottom-10 fade-in duration-200">
